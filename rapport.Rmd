...
\medskip
![Requête n°2](images/R2.png){#uml width="12cm" height="8cm"}
...
```
\medskip
![Requête n°3](images/R3.png){#uml width="12cm" height="8cm"}
...
```
![Requête n°4](images/R4.png){#uml width="10cm" height="6cm"}
...
```
![Requête n°5](images/R5.png){#uml width="15cm" height="8cm"}
...
```
![Requête n°6](images/R6.png){#uml width="8cm" height="4cm"}
...
LIMIT 10;
```
![Requête n°7](images/R7.png){#uml width="12cm" height="8cm"}
...
LIMIT 10;
```
![Requête n°8](images/R8.png){#uml width="12cm" height="8cm"}
...
```
![Requête n°9](images/R9.png){#uml width="6cm" height="4cm"}
...
```
![Requête n°10](images/R10.png){#uml width="6cm" height="4cm"}
...
ips <- read.csv2("data/IPS voie pro.csv")
...
# Lecture des données
reussite <- read.csv2("data/Taux_de_reussite.csv", check.names = TRUE)
reussite$taux_de_reussite <- as.numeric(gsub(",", ".", reussite$taux_de_reussite))

poursuite <- read.csv2("data/Taux_poursuite_etude.csv", check.names = TRUE)
...
# Lecture des données
ips <- read.csv2("data/IPS voie pro.csv", check.names = TRUE)
reussite <- read.csv2("data/Taux_de_reussite.csv", check.names = TRUE)
taux_interruption <- read.csv2("data/Taux_interruption_formation.csv", check.names = TRUE)
taux_poursuite <- read.csv2("data/Taux_poursuite_etude.csv", check.names = TRUE)
...
# Lire le fichier CSV
df <- read_delim("data/lycee_region.csv", delim = ";")
...
df_ips <- read.csv("data/carte ips.csv", sep = ";", fileEncoding = "UTF-8")
...
df <- read.csv("data/TEST DE CORRELATION.csv", 
...
df <- read.csv2("data/TEST DE CORRELATION 2.csv", 
...
interruption <- read.csv2("data/Taux_interruption_formation.csv")
...
df <- read.csv2("data/TEST DE CORRELATION.csv", 
                sep = ";", fileEncoding = "UTF-8")
